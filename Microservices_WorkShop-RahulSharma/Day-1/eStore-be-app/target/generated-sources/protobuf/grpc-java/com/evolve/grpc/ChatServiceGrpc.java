...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.evolve.grpc.ChatProto.ChatMessage,
      com.evolve.grpc.ChatProto.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = com.evolve.grpc.ChatProto.ChatMessage.class,
      responseType = com.evolve.grpc.ChatProto.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.evolve.grpc.ChatProto.ChatMessage,
      com.evolve.grpc.ChatProto.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<com.evolve.grpc.ChatProto.ChatMessage, com.evolve.grpc.ChatProto.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<com.evolve.grpc.ChatProto.ChatMessage, com.evolve.grpc.ChatProto.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.evolve.grpc.ChatProto.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.evolve.grpc.ChatProto.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.evolve.grpc.ChatProto.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.evolve.grpc.ChatProto.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.evolve.grpc.ChatProto.ChatMessage> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.evolve.grpc.ChatProto.ChatMessage,
              com.evolve.grpc.ChatProto.ChatMessage>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.evolve.grpc.ChatProto.getDescriptor();
    }
